...
def animate_paths(ax, paths, colors=None, interval=50, on_frame=None, show_left_forbidden=False, forbidden_rect=(0, 0, 130, 40), invert_y=True):
    """
        ...
        if show_left_forbidden:
            try:
                ...
                if invert_y:
                    ...
                    forb_fill = Rectangle((x0, y0_transformed), w, h, facecolor='pink', alpha=0.3, edgecolor='red', linewidth=2, linestyle='--')
                else:
