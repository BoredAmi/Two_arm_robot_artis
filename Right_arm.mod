...
!                ! Lower pen to start drawing - use moderate speed with smooth zone
            ...
            ELSEIF StrMatch(cmd, 1, "RETREAT")=1 THEN
                ...
                retreat_position := Offs(target_position,-50,0,current_z);  ! Right arm retreats in negative X
...
!                    IF x_coord < -145 OR x_coord > 360 OR y_coord < -105 OR y_coord > 210 THEN
...
!        ENDIF
    ...
    PROC setup_corner()
        ...
        base_position:=  [[20.53,14.09,94.81],[0.0236703,-0.671026,0.0261252,-0.740595],[1,0,-2,4],[159.113,9E+09,9E+09,9E+09,9E+09,9E+09]];
